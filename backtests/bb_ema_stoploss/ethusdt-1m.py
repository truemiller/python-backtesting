...
# Load historical ETH/USDT 1-minute data for backtesting
df1 = pd.read_csv(
    "data\ETHUSDT_1_2023-01-01_2023-01-31.csv",
    header=0,
    names=["Date", "Open", "High", "Low", "Close", "Volume"],
)
df2 = pd.read_csv(
    "data\ETHUSDT_1_2023-02-01_2023-02-28.csv",
    header=0,
    names=["Date", "Open", "High", "Low", "Close", "Volume"],
)
df3 = pd.read_csv(
    "data\ETHUSDT_1_2023-03-01_2023-03-31.csv",
    header=0,
    names=["Date", "Open", "High", "Low", "Close", "Volume"],
)
df4 = pd.read_csv(
    "data\ETHUSDT_1_2023-04-01_2023-04-30.csv",
    header=0,
    names=["Date", "Open", "High", "Low", "Close", "Volume"],
)
df5 = pd.read_csv(
    "data\ETHUSDT_1_2023-05-01_2023-05-31.csv",
    header=0,
    names=["Date", "Open", "High", "Low", "Close", "Volume"],
)
